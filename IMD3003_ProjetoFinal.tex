...
\end{figure}
Com base nesse dendograma foram selecionadas tres alturas de corte interessantes: 12, resultando em 6 clusters; 14, resultando em 5 clusters; e 16, resultando em 4 clusters. As tres alternativas podem ser observadas nos gráficos a seguir:

\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{umap3d_agglomerative_supercluster_K6.png}
\caption{Clusterização aglomerativa, ponto de corte 12 resulta em 6 clusters.}
\label{fig:umap3d-agglomerative}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{umap3d_agglomerative_supercluster_K5.png}
\caption{Clusterização aglomerativa, ponto de corte 14 resulta em 5 clusters.}
\label{fig:umap3d-agglomerative}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.1\textwidth]{umap3d_agglomerative_supercluster_K4.png}
\caption{Clusterização aglomerativa, ponto de corte 16 resulta em 4 clusters.}
\label{fig:umap3d-agglomerative}
\end{figure}

Com base na inspeção visual foi selecionada uma altura de corte 16, que resultou em um particionamento mais equilibrado do supercluster, com 4 clusters resultantes. A abertura correspondente desse agrupamento evidencia subclusters mais estáveis e com melhor separação geométrica.
